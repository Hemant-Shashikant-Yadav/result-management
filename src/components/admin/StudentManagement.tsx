...
import { addStudent, addStudentBulk } from '../../db/students';
...
export default function StudentManagement() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      const students: Student[] = utils.sheet_to_json(worksheet);

      await addStudentBulk(students);
  ...
  return (
    <div className="space-y-8">
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <StudentForm
          onSuccess={() => setSuccess('Student added successfully')}
